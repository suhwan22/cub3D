...
/*   Updated: 2023/04/20 15:23:12 by jeseo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_handler(int key_code, t_info *info)
{
	...
	{
		if (info->map[info->mbase.map.y][(int)(info->mbase.pos.x + info->mbase.dir.x * info->mbase.move_speed)] != '1')
			info->mbase.pos.x += info->mbase.dir.x * info->mbase.move_speed;
		if (info->map[(int)(info->mbase.pos.y + info->mbase.dir.y)][info->mbase.map.x] != '1')
			info->mbase.pos.y += info->mbase.dir.y * info->mbase.move_speed;
	}
	else if (key_code == KEY_DOWN)
	{
		if (info->map[info->mbase.map.y][(int)(info->mbase.pos.x + info->mbase.dir.x)] != '1')
			info->mbase.pos.x -= info->mbase.dir.x * info->mbase.move_speed;
		if (info->map[(int)(info->mbase.pos.y + info->mbase.dir.y)][info->mbase.map.x] != '1')
			info->mbase.pos.y -= info->mbase.dir.y * info->mbase.move_speed;
	}
